...
{
    public class GetApprovedEventsQueryHandler : IRequestHandler<GetApprovedEventsQuery, List<EventDto>>
    {
        private readonly IEventRepository _eventRepository;
        private readonly IMapper _mapper;

        public GetApprovedEventsQueryHandler(IEventRepository eventRepository, IMapper mapper)
        {
        ...
        {
            var events = await _eventRepository.GetApprovedAsync();
